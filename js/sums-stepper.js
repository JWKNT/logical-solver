...
const SUMS_STRATEGIES = [
  ...
  { name: 'Shaded spine', variant: 'blankConn', desc: 'The one coral must place a shaded cell in every line whose clue forces one \u2014 blank-capable pockets that cannot reach such a line hold digits, and a lone bridge on every route between them is shaded.' },
